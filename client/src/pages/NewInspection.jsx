        ...
        <form onSubmit={handleCreate} className="px-6 py-5 space-y-4">
          ...
          <div>
            ...
            {isLoading ? (
              ...
              <select
                ...
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pdi-navy bg-white"
              >
            ...
            {FIELD_CONFIG.map(({ key, label, required, type, wide }) => (
              <div key={key} className={wide ? 'col-span-2' : ''}>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-pdi-navy"
                />
              </div>
            ))}
          </div>
          ...
          <div className="flex justify-end gap-3 pt-2 border-t border-gray-100">
            ...
            <button
              ...
              className="px-5 py-2 text-sm font-semibold bg-pdi-navy text-white rounded-lg hover:bg-pdi-navy/90 disabled:opacity-50 transition-colors"
            >
